...
export const Services: React.FC = () => {
  ...
  return (
    <section
      id="services"
      ref={ref}
      className="relative z-10 w-full max-w-full bg-[#070707] text-[#f7f4ed] pt-10 sm:pt-14 pb-16 sm:pb-20 lg:pb-24 px-6 sm:px-10 md:px-14 lg:px-16 border-t border-white/[0.04] overflow-hidden scroll-mt-20"
    >
      <div className="w-full max-w-7xl mx-auto">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-10 sm:mb-12">
          ...
          <div className={`text-right hidden sm:block reveal-fade-right ${isIntersecting ? 'is-revealed' : ''}`}>
            <a
              href="#contact"
          ...
          {servicesList.map((service, index) => {
            ...
            return (
              <div
                ...
                className={`${animClass} group relative py-8 sm:py-10 transition-all duration-500 cursor-pointer hover:bg-white/[0.02] px-3 sm:px-6 rounded-xl ${

...
export const Capabilities: React.FC = () => {
  ...
  return (
    <section
      id="capabilities"
      ref={ref}
      className="relative z-10 w-full max-w-full bg-[#0a0808] text-[#f7f4ed] py-16 sm:py-20 lg:py-24 px-6 sm:px-10 md:px-14 lg:px-16 border-t border-white/10 overflow-hidden"
    >

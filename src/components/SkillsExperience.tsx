...
export const SkillsExperience: React.FC = () => {
  ...
  return (
    <section
      id="skills"
      ref={ref}
      className="relative z-10 w-full max-w-full bg-[#080707] text-[#f7f4ed] py-10 sm:py-14 px-6 sm:px-10 md:px-14 lg:px-16 border-t border-white/10 overflow-hidden"
    >
